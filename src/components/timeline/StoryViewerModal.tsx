...
export default function StoryViewerModal({
  ...
  const mediaUri = normalizeUrl(story.mediaURL ?? (story as any).mediaUrl) ?? '';
...
const styles = StyleSheet.create({
  ...
  prevZone: { position: 'absolute', left: 0, top: 0, bottom: 0, width: '35%' },
  nextZone: { position: 'absolute', right: 0, top: 0, bottom: 0, width: '35%' },
