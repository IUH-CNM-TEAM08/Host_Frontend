...
const MOCK_POSTS: Post[] = [
  {
    ...
    content: "Đang test giao diện UI/UX mới cho Zala, nhìn xịn xò phết! 😎",
    media: [
      { url: "https://images.unsplash.com/photo-1555066931-4365d14bab8c?auto=format&fit=crop&q=80&w=800", type: "image" }
    ],
    likeCount: 52,
    commentCount: 14,
    isLiked: false,
  ...
  },
  {
    ...
    content: "Team building cuối tuần ở Đà Lạt ☕️🌲",
    media: [
     { url: "https://images.unsplash.com/photo-1540304617572-8785cbdce444?auto=format&fit=crop&q=80&w=800", type: "image"},
     { url: "https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?auto=format&fit=crop&q=80&w=800", type: "image"}
    ],
    likeCount: 128,
    commentCount: 22,
    isLiked: true,
  ...
  },
  {
    ...
    content: "Vừa fix xong con bug siêu khoai sau 3 tiếng đồng hồ 🐛🔨 Ai cứu tuiii",
    likeCount: 15,
    commentCount: 5,
    isLiked: false,
...
const MOCK_STORIES: Story[] = [
  {
    ...
    mediaURL: "https://images.unsplash.com/photo-1524504388940-b1c1722653e1?auto=format&fit=crop&q=80&w=300",
    mediaType: "image",
    viewed: false,
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    mediaURL: "https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?auto=format&fit=crop&q=80&w=300",
    mediaType: "image",
    viewed: true,
    createdAt: new Date().toISOString(),
    expiresAt: new Date().toISOString()
    ...
    mediaURL: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&q=80&w=300",
    mediaType: "image",
    viewed: false,
    createdAt: new Date().toISOString(),
    expiresAt: new Date().toISOString()
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      if (storiesRes.status === 'fulfilled') {
        ...
        setStories(fetched.length > 0 ? fetched : MOCK_STORIES);
      } else {
